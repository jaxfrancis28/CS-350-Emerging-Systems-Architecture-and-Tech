...
#    2          Removed duplicate initialization code, removed
#                duplicate logic in updateLights(), and fixed the
#                altCounter double-increment bug in manageMyDisplay()
#                so the lights refresh every 10 seconds as intended.
#------------------------------------------------------------------
...
class TemperatureMachine(StateMachine):
    ...
    def processTempIncButton(self):
        ...
        self.setPoint += 1 # Increments the temperature set point
        self.updateLights() # Updates the circuit status lights
    ##
    ...
    def processTempDecButton(self):
        ...
        self.setPoint -= 1 # Decrements the temperature set point
        self.updateLights() # Updates the circuit status lights
    ##
    ...
    def setupSerialOutput(self):
        temp = floor(self.getFahrenheit())
        output = f"{self.current_state_value},{temp},{self.setPoint}"
        return output
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                ...
                lcd_line_2 = f"\n{self.current_state_value}, Set: {self.setPoint}F"
